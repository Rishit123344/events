      ...
      <View style={styles.modalContainer}>
        <ScrollView style={{width:'100%'}}>
          <KeyboardAvoidingView style={styles.KeyboardAvoidingView}>
            <Text style={styles.ModalTitle}>Regestration</Text>
...
render(){
    return(
        <View style={styles.container }>
          {this.showModal()}
          <View>
            <Text style={{textAlign:'center',fontSize:50,marginBottom:50,fontStyle:'italic'}}>Event Tracker</Text>
                <Image source={require("../assets/icons8-calendar-600.png")}style={{width:250,height:250,marginBottom:70,marginLeft:50}}/>
            </View>
